            ...
            <div>
                ...
                <div className=" mb-10">
                    ...
                    <div className="flex">
                        ...
                        <input type="text" placeholder="Search Members" className="bg-white shadow-lg rounded-2xl p-3 mr-2 w-full focus:outline-none" value={searchKey} onChange={(e)=>setSearchKey(e.target.value)}  onKeyDown={handleKeyDown}/>
                        <button

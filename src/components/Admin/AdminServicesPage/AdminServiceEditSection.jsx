  ...
  return (
    ...
    <div>
        ...
        <div className="mb-5 flex justify-between">
            ...
            <button onClick={updateThisService} className="  bg-transparent text-[#397f77] border-[#397f77] border-[1px] px-7 py-3 text-lg rounded-xl font-semibold hover:bg-[#18debb] hover:text-white hover:border-white duration-300">Update Service</button>
        </div>
